...
" Colors
	...
	hi User1 ctermbg=darkgrey ctermfg=white guibg=black guifg=white
	hi User3 ctermbg=darkgrey  ctermfg=lightcyan guibg=black guifg=lightcyan
	hi User4 ctermbg=darkgrey ctermfg=green guibg=black guifg=lightgreen
...
" Closing HTML inline tags(personal add)
	inoremap ><Space> ><Esc>F<lyt>A</<C-r>"><Esc>2ba
" In case that is for certain filetypes only
" autocmd FileType html,xml,xhtml,jsx,tsx,javascriptreact,typescriptreact,vue,svelte inoremap ><Space> ><Esc>F<lyt>A</<C-r>"><Esc>2ba

" Closing HTML block tags(personal add)
	inoremap ><Tab> ><Esc>F<lyt>o</<C-r>"><Esc>O<Space>
" In case that is for certain filetypes only
" autocmd FileType html,xml,xhtml,jsx,tsx,javascriptreact,typescriptreact,vue,svelte inoremap ><Tab> ><Esc>F<lyt>o</<C-r>"><Esc>O<Space>
